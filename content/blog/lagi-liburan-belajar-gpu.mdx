...
pubDate: Jan 7 2024
heroImage: /images/blog/lagi-liburan-belajar-gpu/throughput-vs-latency.png
---
...
Kebetulan penasaran juga sama cara kerja GPU. Lagi belajar-belajar soal shader karena kena racun suatu former gamedev (_ekhem_ Om didiet _ekhem_).
...
![Nobody Cares About FLOPs](/images/blog/lagi-liburan-belajar-gpu/nobody-cares-about-flops.png)
...
![Data latency](/images/blog/lagi-liburan-belajar-gpu/latency.png)
...
![Computation Efficiency](/images/blog/lagi-liburan-belajar-gpu/efficiency.png)
...
![Latency per Memory](/images/blog/lagi-liburan-belajar-gpu/latency-per-memory.png)
...
![throughput vs Latency](/images/blog/lagi-liburan-belajar-gpu/throughput-vs-latency.png)
