...
pubDate: Jan 23 2024
heroImage: /images/blog/jadi-monad-itu-apa/monad.png
---
...
Bagian _"Monads provide a convenient framework for simulating effects found in other languages, such as global state, exception handling, output, or non-determinism."_
...
<ImgCaption
  src="https://miro.medium.com/v2/resize:fit:1400/0*uh4tBSWjidlCTdhJ"
  caption="Monad sebagai wrapper. Sumber https://www.continuum.be/en/blog/a-gentle-introduction-to-monads/"
  alt="monad sebagai wrapper"
/>
